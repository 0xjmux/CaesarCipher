...
inText = input("Insert text to encrypt: ")
...
for index, value in enumerate(inText):    #goes through the entered text and encrypts it
    temp = alphabet[value]
    temp = temp + shift
    if temp > 26:
        temp -= 26
...
print(TextCrypt)    #prints the encrypted text
